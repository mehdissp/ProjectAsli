...
// // import EditPropertyModal from './EditPropertyModal'; // اضافه کنید
...
// // const [selectedPropertyForEdit, setSelectedPropertyForEdit] = useState(null); // تغییر نام
...
// //                            onClick={(e) => {
// //     e.stopPropagation();
// //     setSelectedPaymentProperty(property);
// //   }}
...
// //         />
// //       )}
// // {/* مدال ویرایش ملک - جدید */}
// // {isEditModalOpen && selectedPropertyForEdit && (
// //   <EditPropertyModal
...
// //     onSuccess={() => {
// //       fetchUserProperties();
// //       showToast('ملک با موفقیت ویرایش شد', 'success');
// //     }}
...
// const UserPropertiesPanel = () => {
//   const navigate = useNavigate();
//   const [activeTab, setActiveTab] = useState('properties'); // 'properties' or 'stories'
//   const [properties, setProperties] = useState([]);
//   const [loading, setLoading] = useState(true);
//   const [error, setError] = useState(null);
//   const [selectedProperty, setSelectedProperty] = useState(null);
...
//         setProperties(prev => prev.map(p => 
//           p.id === propertyId 
//             ? { ...p, status: newStatus, originalStatus: persianStatus } 
//             : p
//         ));
...
//   // اگر در تب استوری هستیم، کامپوننت استوری را نمایش بده
...
//           </button>
//           <button 
//             className={`panel-tab ${activeTab === 'stories' ? 'active' : ''}`}
...
//       <div className="user-properties-compact">
//         <div className="panel-tabs">
//           <button className="panel-tab active">🏠 املاک من</button>
//           <button className="panel-tab">📸 استوری‌های من</button>
//         </div>
//         <div className="compact-loading">
//           <div className="compact-spinner"></div>
//           <p>در حال بارگذاری...</p>
...
//           <h4>ملکی یافت نشد</h4>
//           <p>هیچ ملکی با این مشخصات وجود ندارد</p>
//           <button onClick={() => setIsAddModalOpen(true)}>ثبت ملک جدید</button>
//         </div>
//       ) : (
//         <div className={`compact-properties ${viewMode}`}>
//           {viewMode === 'grid' 
...
//                           onClick={(e) => {
//                             e.stopPropagation();
//                             handleStatusChange(property.id, 'sold');
//                           }}
//                           title="فروخته شده"
//                         >
//                           💰
...
//                           onClick={(e) => {
//                             e.stopPropagation();
//                             handleStatusChange(property.id, 'archived');
//                           }}
//                           title="بایگانی"
//                         >
//                           📦
...
const UserPropertiesPanel = () => {
  ...
  // ✅ تابع جدید برای دریافت PDF
  const handlePrintPdf = async (propertyId, e) => {
    ...
    try {
      showToast('در حال تولید فایل PDF...', 'success');
      
      const response = await fetch(
        `https://localhost:7178/api/Pdf/GeneratePropertyPdf?id=${propertyId}`,
        {
          method: 'GET',
          headers: {
            'Authorization': `Bearer ${token}`,
      ...
      if (error.message.includes('منقضی')) {
        ...
        showToast(error.message || 'خطا در تولید PDF', 'error');
      }
    }
  };
  ...
  const handleStatusChange = async (propertyId, newStatus) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://localhost:7178/api/RealEstatePage/GetPaymentStatus?id=${propertyId}`,
        {
          method: 'GET',
          headers: {
            'Authorization': `Bearer ${token}`,
                  ...
                  >
                    ...
                    <div className="compact-card-content">
                      ...
                      <div className="compact-card-actions">
                        ...
                        {/* دکمه PDF */}
                        <button 
                          className="compact-pdf-btn"
                          onClick={(e) => {
                            e.stopPropagation();
                            handlePrintPdf(property.id, e);
                          }}
                          title="دریافت PDF"
                        >
                          📄
