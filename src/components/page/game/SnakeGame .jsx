...
// src/pages/Games/SnakeGame.jsx
import React, { useState, useEffect, useCallback, useRef } from 'react';
import LoginModal from '../RealEstateDetailPageItem/LoginModal/LoginModal';

// ================ متا تگ‌های کامل ================
const MetaTags = () => {
  const siteUrl = process.env.REACT_APP_SITE_URL || 'https://your-site.com';
  const currentUrl = `${siteUrl}/games/snake-game`;
  const imageUrl = `${siteUrl}/images/snake-game-preview.jpg`;

  return (
    <>
      {/* تایتل و توضیحات اصلی */}
      <title>بازی مار هوشمند | مشاوراملاکی - سرگرمی و چالش</title>
      <meta name="description" content="بازی کلاسیک مار با گرافیک مدرن و امکانات پیشرفته. امتیاز بگیر، رکورد بزن و با دوستانت رقابت کن. کاملاً رایگان و بدون نیاز به نصب." />
      <meta name="keywords" content="بازی مار, مار استاد, بازی آنلاین, سرگرمی, مشاوراملاکی, رتبه‌بندی, بازی فکری, چالش, بازی کامپیوتر, بازی موبایل" />
      
      {/* متا تگ‌های robots کامل */}
      <meta name="robots" content="index, follow, max-snippet:160, max-image-preview:large" />
      <meta name="googlebot" content="index, follow, max-snippet:160, max-image-preview:large" />
      <meta name="author" content="مشاوراملاکی" />
      <meta name="publisher" content="مشاوراملاکی" />
      
      {/* Canonical و Hreflang */}
      <link rel="canonical" href={currentUrl} />
      <link rel="alternate" href={currentUrl} hrefLang="fa-IR" />
      <link rel="alternate" href={`${siteUrl}/en/games/snake-game`} hrefLang="en-US" />
      <link rel="alternate" href={currentUrl} hrefLang="x-default" />
      
      {/* Open Graph */}
      <meta property="og:title" content="بازی مار استاد - سرگرمی و چالش در مشاوراملاکی" />
      <meta property="og:description" content="بازی کلاسیک مار با گرافیک مدرن و امکانات پیشرفته. ثبت امتیاز و رقابت با دیگر بازیکنان." />
      <meta property="og:type" content="game" />
      <meta property="og:url" content={currentUrl} />
      <meta property="og:image" content={imageUrl} />
      <meta property="og:image:width" content="1200" />
      <meta property="og:image:height" content="630" />
      <meta property="og:image:alt" content="بازی مار استاد - صفحه بازی مشاوراملاکی" />
      <meta property="og:site_name" content="مشاوراملاکی" />
      ...
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="بازی مار استاد - مشاوراملاکی" />
      <meta name="twitter:description" content="بازی کلاسیک مار با امکانات پیشرفته و رقابت آنلاین" />
      <meta name="twitter:image" content={imageUrl} />
      <meta name="twitter:image:alt" content="بازی مار استاد - مشاوراملاکی" />
      <meta name="twitter:site" content="@moshaveremlak" />
      <meta name="twitter:creator" content="@moshaveremlak" />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "VideoGame",
            "name": "بازی مار استاد",
            "description": "بازی کلاسیک مار با گرافیک مدرن و امکانات ویژه. شامل سیستم رتبه‌بندی، امتیازدهی پویا و سطوح مختلف.",
            "applicationCategory": "Game",
            "operatingSystem": "All",
            "author": {
              "@type": "Organization",
            ...
            "gamePlatform": ["Desktop", "Mobile", "Web"],
            "inLanguage": "fa-IR",
            "url": currentUrl,
            "thumbnailUrl": imageUrl,
            "keywords": "بازی مار, سرگرمی, چالش, رقابت, امتیاز"
          })
        }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            "headline": "بازی مار استاد - سرگرمی و چالش در مشاوراملاکی",
            "description": "آموزش و راهنمای بازی مار استاد با نکات و ترفندهای حرفه‌ای برای کسب امتیاز بالا",
            "author": {
              "@type": "Organization",
              "name": "مشاوراملاکی"
            },
  ...
  return (
    <>
      ...
      <div className="game-wrapper" dir="rtl">
        ...
        {/* ===== محتوای سئو ===== */}
        <div className="seo-content" itemScope itemType="https://schema.org/Article">
          <h1 itemProp="headline">بازی مار استاد - سرگرمی و چالش در مشاوراملاکی</h1>
          
          <p itemProp="description">
            بازی مار استاد یک بازی کلاسیک و سرگرم‌کننده است که در سایت <a href="/">مشاوراملاکی</a> 
            طراحی شده تا لحظات خوشی را برای شما به ارمغان بیاورد. این بازی با گرافیک مدرن و 
            امکانات پیشرفته، تجربه‌ای متفاوت از بازی‌های سنتی مار ارائه می‌دهد.
          </p>

          <h2>ویژگی‌های بازی مار استاد</h2>
          <ul>
            <li>🎮 <strong>گرافیک زیبا و مدرن</strong> با افکت‌های ویژه و انیمیشن‌های جذاب</li>
            <li>💯 <strong>سیستم امتیازدهی پویا</strong> با ترکیب (کامبو) و جوایز ویژه</li>
            <li>⭐ <strong>غذاهای ویژه</strong> با امتیاز بیشتر و افکت‌های خاص</li>
            <li>📈 <strong>سطح‌بندی پیشرفته</strong> با افزایش سرعت در هر سطح</li>
            <li>📱 <strong>قابل بازی در موبایل و دسکتاپ</strong> با کنترل‌های لمسی</li>
            <li>🏆 <strong>سیستم رتبه‌بندی</strong> و مسابقات با سایر بازیکنان</li>
          </ul>

          <h2>راهنمای کامل بازی مار</h2>
          <ol>
            <li>با کلیدهای جهت‌نما (<kbd>↑</kbd> <kbd>↓</kbd> <kbd>←</kbd> <kbd>→</kbd>) مار را حرکت دهید</li>
            <li>برای شروع بازی کلید <kbd>Space</kbd> را بزنید</li>
            <li>غذاهای قرمز رنگ را بخورید تا امتیاز بگیرید</li>
            <li>غذاهای طلایی ویژه امتیاز بیشتری دارند</li>
            <li>هر ۵ غذا خوردن، سطح شما افزایش می‌یابد</li>
            <li>با ترکیب‌های پیاپی، امتیاز کامبو دریافت کنید</li>
          </ol>

          <h2>چرا بازی مار استاد را انتخاب کنیم؟</h2>
          <p>
            بازی مار استاد نه تنها یک سرگرمی ساده، بلکه یک چالش فکری و تمرینی برای افزایش 
            سرعت عکس‌العمل و تصمیم‌گیری شماست. با سیستم رتبه‌بندی پیشرفته، می‌توانید 
            با دوستان خود رقابت کرده و بهترین باشید.
          </p>

          <h3>نکات طلایی برای کسب امتیاز بالا</h3>
          <ul>
            <li>🔑 <strong>برنامه‌ریزی کنید:</strong> مسیر حرکت مار خود را از قبل برنامه‌ریزی کنید</li>
            <li>🎯 <strong>به سوی غذاهای ویژه بروید:</strong> غذاهای طلایی امتیاز بیشتری دارند</li>
            <li>⚡ <strong>کامبو بگیرید:</strong> غذاها را پشت سر هم بخورید</li>
            <li>🧠 <strong>محیط را بشناسید:</strong> از فضای تخته به بهترین شکل استفاده کنید</li>
          </ul>
          ...
          <div className="seo-tags">
            ...
            <span className="tag">#بازی_آنلاین</span>
            <span className="tag">#سرگرمی</span>
            <span className="tag">#چالش_فکری</span>
            <span className="tag">#بازی_فکری</span>
          </div>
          
          <div className="seo-cta">
            <p>آماده‌ای رکورد بزنی؟ <a href="/games/snake-game">همین حالا بازی کن!</a></p>
          </div>
        </div>
      </div>
